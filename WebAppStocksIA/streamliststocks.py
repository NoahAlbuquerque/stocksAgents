...
yahoo_finance_tool = Tool(
    ...
    description = "Fetches stock prices for {ticket} form the last year about a specific stock from Yahoo Finance API",
    func = lambda ticket: fetch_stock_price(ticket)
)

# Importando OpenAI LLM -GPT

os.environ['OPEN_API_KEY'] = ""             #PASSAR TOKEN AQUI
...
stockPriceAnalyst = Agent(
    ...
    backstory = """You are a highly experienced in analyzing the price of an specific stock
...
newsAnalyst = Agent(
    ...
    backstory = """ You are highly experienced in analyzing the market trends and news and have tracked assest for more then 10 years.

    You are also master level analyts in the tradicional markets and have deep understanding of human psychology.
...
stockAnalystWrite = Agent(
    ...
    goal = """ Analyze the trends price and news and write an insighfull compelling and informative 3 praragraph long newsletter based on the stock""",
...
writeAnalyses = Task(
    ...
    that is brief and higlights the most important points.
    Focus on the stock price trend, news and fear/greed score. What are the near future considerations?
    Include the previous analyses of stock trend and news sumary.
""",
expected_output = """ An aloquent 3 paragraphs newsletter formated as markdown in an easy readable manner. It should contain:

- 3 bullets executive summary
- Introduction - set the overall picture and spike up the interest
- main part provides the meat of the analysis including the news sumary and fead/greed scores
- sumary - key facts and concrete future trend prediction - up, down or sideways.
""",
